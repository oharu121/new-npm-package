/**
 * E2E tests for new-npm-package CLI
 *
...
const TEST_PACKAGE_PATH_ABSOLUTE = join(process.cwd(), TEST_PACKAGE_PATH_RELATIVE);
...
describe('E2E: CLI generates working project', () => {
  ...
  it('should generate project with -y flag', () => {
    ...
    execSync(`node dist/index.js ${TEST_PACKAGE_PATH_RELATIVE} -y --skip-install`, {
      stdio: 'pipe',
      cwd: process.cwd(),
    });
